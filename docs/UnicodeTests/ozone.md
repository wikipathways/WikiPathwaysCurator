# Ozone chemical formula can use Unicode

This test checks for labels of ozone data nodes which can use [Unicode](https://en.wikipedia.org/wiki/Unicode_subscripts_and_superscripts#Superscripts_and_subscripts_block).
...
Open the pathway and replace the O₃ label with a O₂ label.
